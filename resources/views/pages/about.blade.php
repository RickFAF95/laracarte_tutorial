...
@section('content')
    <div class="container">
        ...
        <p>
            {{ config('app.name') }} is a clone app of <a href="https://laramap.com">Laramap.com</a>.
        </p>
        <div class="row">
            <div class="col-md-6">
        ...
        <p> Feel free to help to improve the <a href="https://github.com/RickFAF95/{{ config('app.name') }}_tutorial">source code</a>. </p>
        <hr>
